...
//         const conversationArea = document.getElementById("conversationArea");
//
//         // 발신자에 따라 전체 컨테이너의 정렬 클래스를 지정합니다.
...
//             //     "flex justify-end block";
//             messageSender.textContent = currentUser.userName
...
//             const messageSender = document.createElement("strong");
//             // messageSender.className =
//             //     "flex justify-start block";
//             messageSender.textContent = targetUser.userName
//             messageContainer.appendChild(messageSender);
//         }
//
//
...
//     }
//
//     // 이하 회원 정보, PT, 식단, 운동 관련 함수들 (showPTInfo, editPT, savePT, cancelEdit, showMealsInfo, noMealsInfo, showWorkInfo, noWorkInfo, showUserInfo, noUserInfo 등)
//     // -- 기존 memberManage.js에 있던 함수들을 그대로 유지합니다.
//
//     function showPTInfo(response, userId) {
//         const $userInfoDiv = $("#userPTInfo");
//         $userInfoDiv.html(`
...
//                       <div class="card shadow-sm border-0 p-4">
//                         <div class="card-body">
//                           ${meal.savedFileName ? `<img src="/uploads/meal/${meal.savedFileName}" class="w-44 h-44 rounded mb-3 shadow-sm border-black border-2 object-cover" alt="식단 이미지">` : ""}
//                           <h6 class="card-subtitle mb-2 text-muted">${meal.mealType}</h6>
//                           <p class="card-text">🔥 칼로리: <span>${meal.totalCalories}</span> kcal</p>
//                           <p class="card-text">🍞 탄수화물: <span>${meal.totalCarbs}</span> g</p>
//                           <p class="card-text">🍗 단백질: <span>${meal.totalProtein}</span> g</p>
//                           <p class="card-text">🥑 지방: <span>${meal.totalFat}</span> g</p>
//                         </div>
//                       </div>
//                     </div>
//                   </div>
...
//               <tbody>
//                 <tr>
//                   <td id="height">${latestData.height} cm</td>
//                   <td id="weight">${latestData.weight} kg</td>
//                   <td id="bmi">${latestData.bmi}</td>
//                   <td id="fatMass">${latestData.fatMass}%</td>
//                   <td id="muscleMass">${latestData.muscleMass}</td>
//                   <td id="basalMetabolicRate">${latestData.basalMetabolicRate} kcal</td>
//                 </tr>
//               </tbody>
//             </table>
//         `;
//         $userInfoDiv.html(workHtml);
//     }
//
//     function noUserInfo() {
//         const $userInfoDiv = $("#user-card");
//         $userInfoDiv.html("해당 이용자의 최신 신체 정보가 없습니다");
//     }
//
//     $(document).on("click", ".select-btn", function (event) {
